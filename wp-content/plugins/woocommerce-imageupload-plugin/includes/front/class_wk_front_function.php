...
class Wk_front_function
{
     ...
     */
    public function wk_save_custom_field( $cart_item, $product_id ) {
     ...
     */
    public function wk_gift_note_item_data( $cart_item_data, $cart_item ) {
    ...
    public function backend_image_link_after_order_itemmeta( $item_id, $item, $product ) {
